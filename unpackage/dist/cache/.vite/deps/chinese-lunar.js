...
// ../../../../github/yuyi/node_modules/chinese-lunar/lib/chinese-lunar.js
var require_chinese_lunar = __commonJS({
  "../../../../github/yuyi/node_modules/chinese-lunar/lib/chinese-lunar.js"(exports, module) {
    (function() {
      var MAPPING = [
      ...
      _chineseLunar.monthDiff = function(lunar1, lunar2) {
        ...
        if (lunar1.year == lunar2.year) {
          ...
          count = 12;
          if (lunar1.leapMonth > lunar1.month || lunar1.leapMonth == lunar1.month && !lunar1.isLeaMonth)
            count += 1;
          count -= lunar1.month;
...
export default require_chinese_lunar();
